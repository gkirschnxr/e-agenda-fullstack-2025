...
public class SelecionarContatoPorIdQueryHandler(IRepositorioContato repositorioContato,
...
{
    public async Task<Result<SelecionarContatoPorIdResult>> Handle(SelecionarContatoPorIdQuery query, 
